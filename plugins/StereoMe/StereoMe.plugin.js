 ...
 * @source https://raw.githubusercontent.com/CelestialReaver/bd-addons/main/plugins/StereoMe.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
	const config = {
		...
		info: {
			...
			github: "https://github.com/CelestialReaver/BetterDiscord",
			github_raw:
				"https://raw.githubusercontent.com/CelestialReaver/BetterDiscord/main/plugins/StereoMe/StereoMe.plugin.js",
		},
		changelog: [
			{ title: "Release", items: ["First Release"] },
		],
		defaultConfig: [
			{
				type: "switch",
	...
	return !global.ZeresPluginLibrary
		...
		: (([Plugin, Api]) => {
				const plugin = (Plugin, Library) => {
					...
					return class StereoMe extends Plugin {
						onStart() {
						...
						settingsWarning() {
							...
							if (
								...
								if (this.settings.enableToasts) {
									Toasts.show(
										"Please disable echo cancellation, noise reduction, and noise suppression for StereoMe",
